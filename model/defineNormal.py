...
class basicNetwork(nn.Module):
    def __init__(self, inplane, outplane):
        ...
        # combine everyting
        self.combine_conv1 = nn.Conv2d(self.nFilters, outplane, kernel_size=1, stride=1, padding=0, bias=False)
        self.combine_bn1 = nn.BatchNorm2d(outplane)
        self.combine_conv2 = nn.Conv2d(outplane, outplane, kernel_size=1, stride=1, padding=0, bias=False)
