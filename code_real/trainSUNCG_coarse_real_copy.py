...
def help_computeNetwork(data_compare, data_SAW, writer, epoch, i, indType='train'):
    ...
    #print 'time used forward for SUNCG is %s' % (time.time() - begin_time)
    ...
    #print 'time used to get loss for SUNCG is %s' % (time.time() - begin_time)
    #print 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
    
    images_IIW_compare = Variable(image_IIW_compare.cuda()).float()
    #begin_time = time.time()
    output_IIW_compare = network.forward(images_IIW_compare) 
    #print 'time used forward for IIW is %s' % (time.time() - begin_time)
    ...
    #print 'time used to get loss for IIW is %s' % (time.time() - begin_time)
    #begin_time = time.time()
