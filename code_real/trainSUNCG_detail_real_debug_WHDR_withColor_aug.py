...
from utils_toGPU_augment import *
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        network_fine.model.cpu()
        torch.save(network_fine.model.state_dict(), tmp_saveName)
        network_fine.model.cuda()
    network_fine.model.cpu()
    torch.save(network_fine.model, os.path.join(savePath, 'trained_model.t7'))
    fid.close()
    fid_test.close()
    fid_sep.close()
    fid_test_sep.close()
