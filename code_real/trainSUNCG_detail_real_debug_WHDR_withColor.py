...
def help_computeNetwork(data_compare, data_SAW, writer, epoch, i, indType='train'):
    ...
    label_IIW_compare = labelToGPU.toGPU(label_IIW_compare, indType) 
    ...
    #output_SUNCG_SAW_coarse = network_coarse.forward(images_SUNCG_SAW) 
    #output_SUNCG_SAW_fine = network_fine.forward(images_SUNCG_SAW, output_SUNCG_SAW_fine) 
    #output_SUNCG_SAW = network_detail.forward(images_SUNCG_SAW, output_SUNCG_SAW_detail) 
    #label_SUNCG_SAW = labelToGPU.toGPU(label_SUNCG_SAW, indType) 
    ...
    ##output_IIW_SAW = network_coarse.forward(images_IIW_SAW) 
    ##label_IIW_SAW = labelToGPU.toGPU(label_IIW_SAW, indType) 
    ...
    ##output_NYU_SAW = network_coarse.forward(images_NYU_SAW) 
    ##label_NYU_SAW = labelToGPU.toGPU(label_NYU_SAW, indType) 
...
def main():
    ...
    #        'SUNCG_normal_loss']
    lossName = ['SUNCG_WHDR', 'IIW_WHDR', 'IIW_color', 'IIW_color_grad', 'IIW_reconstruct', 
            'IIW_reconstruct_grad', 'SUNCG_normal_loss']
