...
def help_computeNetwork(data_compare, data_SAW, writer, epoch, i, indType='train'):
    ...
    output_SUNCG_compare = network_fine.forward(images_SUNCG_compare, output_SUNCG_compare_coarse) 
    ...
    output_SUNCG_SAW = network_fine.forward(images_SUNCG_SAW, output_SUNCG_SAW_coarse) 
